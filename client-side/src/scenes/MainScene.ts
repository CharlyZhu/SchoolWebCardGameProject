...
export class MainScene extends Phaser.Scene {
    ...
    public preload() {
        ...
        this.load.image(
            "button-normal",
            "assets/sprites/ui/button-normal1.png"
        );
        this.load.image(
            "button-highlighted",
            "assets/sprites/ui/button-normal2.png"
        );
        this.load.image(
            "button-disabled",
            "assets/sprites/ui/button-normal3.png"
        );
        ...
        this.load.image(
            "time-meter-fill",
            "assets/sprites/ui/time-meter-fill.png"
        );

        this.load.spritesheet(
            "knight-idle",
            "assets/sprites/characters/noBKG_KnightIdle_strip.png",
            { frameWidth: 64, frameHeight: 64 }
        );
        this.load.spritesheet(
            "knight-attack",
            "assets/sprites/characters/noBKG_KnightAttack_strip.png",
    ...
    public async loadCardSprites(): Promise<void> {
        await new Promise((resolve) => {
            for (let i = 0; i < cardMgr.getCardListLength(); i++)
                this.load.image(
                    cardMgr.getCardName(i),
                    cardMgr.getCardImgURL(i)
                );
            resolve();
        });
    }
    ...
    public renderGameObjects() {
        ...
        let enemyCharacterComponent = new Character(
            this,
            1120,
            180,
            "knight-idle",
        ...
        let healthStats = new PlayerStats(
            this,
            1000,
            300,
            "icon-1",
        ...
        let manaStatus = new PlayerStats(
            this,
            1000,
            320,
            "icon-2",
        ...
        let armourStats = new PlayerStats(
            this,
            1000,
            340,
            "icon-3",
        ...
        let weaponStatus = new PlayerStats(
            this,
            1000,
            360,
            "icon-4",
        ...
        let enemyHealthStats = new PlayerStats(
            this,
            1000,
            400,
            "icon-1",
        ...
        let enemyManaStatus = new PlayerStats(
            this,
            1000,
            420,
            "icon-2",
        ...
        let enemyArmourStats = new PlayerStats(
            this,
            1000,
            440,
            "icon-3",
        ...
        let enemyWeaponStatus = new PlayerStats(
            this,
            1000,
            460,
            "icon-4",
        ...
        this.add.existing(messageBoxComponent);
        this.add.existing(cardHolderComponent);
        this.add.existing(characterComponent);
        this.add.existing(enemyCharacterComponent);
        this.add.existing(endTurnButton);
        this.add.existing(queueNotice);

        this.add.existing(healthStats);
        this.add.existing(manaStatus);
        this.add.existing(armourStats);
        this.add.existing(weaponStatus);

        this.add.existing(enemyHealthStats);
        this.add.existing(enemyManaStatus);
        this.add.existing(enemyArmourStats);
        this.add.existing(enemyWeaponStatus);

        this.add.existing(timeMeter);
    }
